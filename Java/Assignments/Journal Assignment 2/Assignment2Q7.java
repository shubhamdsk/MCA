/*
7).Write a Menu driven program for the following string operations
a) To find reverse string
b) Concatenate Two Strings.
c) Find the Length of the String.
d) to Use Equals Method In a String Class
e) To convert given string in Uppercase.
f) To convert given string in lowercase.
 */
